...
public class BrowserUtils {
    ...
    public static void waitForClickablility(WebDriver driver, By cssSelector, int i) {
    }
    ...
    public static String getScreenshot(String name)  {
        ...
        String date = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy_MM_dd_hh_mm_ss a"));
