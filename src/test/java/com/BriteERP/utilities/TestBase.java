...
public class TestBase {
    ...
    //we need this object for building reports, but it doesn't build itself//we have 3 instanses
    protected ExtentReports report;
    protected ExtentHtmlReporter htmlReporter;//creates a rich standalong HTML file
    ...
    public void testSetup(){
        ...
        htmlReporter.config().setDocumentTitle("Brite ERP Automation");
